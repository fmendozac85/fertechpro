...
De las cinco anteriores, hay una que las potencia a todas. Y esa es el ownership.
¿Qué es el ownership y en qué se diferencia de la accountability? Es una confusión común, así que lo pongo claro:
...
- **Caso 1: La solicitud llegó tarde**
Un área necesita un reporte urgente de tu aplicación, pero tardó en formalizar la solicitud y ahora están contra el tiempo.
...
- **Caso 2: El sistema dejó de vender un sábado**
Las incidencias no avisan. No piden permiso. Y el PM con ownership lo sabe.
